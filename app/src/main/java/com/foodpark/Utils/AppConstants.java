...
public class AppConstants {
    ...
    public static final String KEY_FOOD = "Foods";
    public static final String KEY_CATEGORY_ID = "CategoryId";
    public static final String KEY_CATEGORIES = "Categories";
    public static final String KEY_USER = "User";
    public static final String KEY_FOODID = "FoodId";
    public static final String KEY_REQUESTS = "Requests";
    public static final String KEY_ORDER_PLACED = "0";
    public static final String KEY_ORDER_SHIPPING = "1";
    public static final String KEY_ORDER_SHIPPED = "2";
